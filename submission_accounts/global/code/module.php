...
function submission_accounts__update($old_version_info, $new_version_info)
{
  global $g_table_prefix;
...
/**
 * The old upgrade function. Left in for backward compatibility with pre 2.1.4 Core versions.
 *
 * @param unknown_type $old_version
